# -*- coding: utf-8 -*-
#
# TIDAS documentation build configuration file, created by
...
#html_title = 'TIDAS ({})'.format(fullversion)
...
# of the sidebar.
html_logo = os.path.join('_static', 'tidas_logo_small.png')
