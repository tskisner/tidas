...
class intrvl {
    public:
        ...
        intrvl(time_type new_start, time_type new_stop, index_type new_first,
               index_type new_last);
...
class intervals_backend {
    public:
        ...
        virtual void read_data(backend_path const & loc,
                               interval_list & intr) const = 0;

        virtual void write_data(backend_path const & loc,
                                interval_list const & intr) = 0;
...
class intervals {
    public:
        ...
        void copy(intervals const & other, std::string const & filter,
                  backend_path const & loc);
...
#endif // ifndef TIDAS_INTERVALS_HPP
