...
void filter_sub(std::string const & filter, std::string & root,
                std::string & subfilter);

void filter_block(std::string const & filter, std::string & local,
                  std::string & subfilter, bool & stop);
