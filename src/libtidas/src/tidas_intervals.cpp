...
tidas::intrvl::intrvl(time_type new_start, time_type new_stop, index_type new_first,
                      index_type new_last) {
    start = new_start;
    stop = new_stop;
    first = new_first;
...
tidas::intervals::intervals(intervals const & other, std::string const & filter,
...
void tidas::intervals::copy(intervals const & other, string const & filter,
                            backend_path const & loc) {
