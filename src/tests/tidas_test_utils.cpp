...
TEST(utilstest, filter) {
    ...
    string grpsub = submatch_begin + schema_submatch_key + submatch_assign + string(
        "field.*") + submatch_sep
                    + dict_submatch_key + submatch_assign + string("prop.*") +
                    submatch_end;
    ...
    string intrsub = submatch_begin + dict_submatch_key + submatch_assign + string(
        "pr.*") + submatch_end;
    ...
    string blksub = submatch_begin + group_submatch_key + submatch_assign + grpmatch +
                    submatch_sep
                    + intervals_submatch_key + submatch_assign + intrmatch +
                    submatch_end;
